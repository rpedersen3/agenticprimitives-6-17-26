...
Must-fix-before-Base-Sepolia: **M-3 (done)**. Hardening wave (2026-06-06): **H-1, M-2, L-1 FIXED**. Remaining tracked: **M-1** (needs demo-a2a KV/DO infra), **I-1**, **I-2**.
