...
| ---------------------------------------------------------- | --------------------------------------------- | ------------------------------------------------- |
| Passkey ceremony, SIWE, sessions, signer interfaces        | `packages/identity-auth/CLAUDE.md`            | No smart-account deployment logic here.           |
...
| Custody policy, recovery, quorum signatures, admin actions | `packages/custody/CLAUDE.md`                  | Keep custody vocabulary out of delegation.        |
...
| AgentCard/profile JSON, CAIP-10 native IDs                 | `packages/agent-identity/CLAUDE.md`           | Off-chain profile schema and verification.        |
