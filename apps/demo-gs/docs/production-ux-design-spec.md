...
Structural wireframe mockups for the screens below. They are **SVG** (vector, version-controlled,
~8 KB each — not raster), generated by [`assets/_gen-mockups.mjs`](assets/_gen-mockups.mjs) — re-run
`node apps/demo-gs/docs/assets/_gen-mockups.mjs` to regenerate after editing. They communicate layout +
hierarchy + the demo-gs indigo palette (a structural spec, not a style refresh); a later polish pass can
swap in higher-fidelity renders. The detailed screen specs in §15a are the textual companion.

### Landing Page

<img src="assets/demo-gs-landing.svg" alt="Global Switchboard signed-out landing" width="900" />

### Role-Aware Connect + Grant Review

<img src="assets/demo-gs-connect-grant-review.svg" alt="Role-aware connect and grant review before handoff" width="900" />

### Post-Connect Role Discovery

<img src="assets/demo-gs-role-discovery.svg" alt="Post-connect role discovery timeline and access table" width="900" />

### Connected Role Hub

<img src="assets/demo-gs-role-hub.svg" alt="Connected role hub: GCO and KC workspaces" width="900" />

### GCO Organization Workspace

<img src="assets/demo-gs-gco-dashboard.svg" alt="GCO Organization workspace: need lifecycle and supply directory" width="900" />

### KC Expert Workspace

<img src="assets/demo-gs-kc-dashboard.svg" alt="KC Expert workspace: offering and demand directory" width="900" />

### Header Dropdown

<img src="assets/demo-gs-header-dropdown.svg" alt="Connected identity dropdown with Jane/Pete demo shortcuts" width="900" />

### Match To Agreement Timeline

<img src="assets/demo-gs-deep-match-agreement.svg" alt="Match to agreement timeline across the four actors" width="900" />

### Jane / Switchboard Broker Demo Admin

<img src="assets/demo-gs-broker-board.svg" alt="Jane / Switchboard broker demo admin: bridge, match board, public signal" width="900" />

### Missing-Delegation / Request-Access State

<img src="assets/demo-gs-access-request-state.svg" alt="Missing delegation request-access state" width="900" />
