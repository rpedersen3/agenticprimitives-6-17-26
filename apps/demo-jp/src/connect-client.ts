 ...
 *  AUDIT NEW-RAG-2: `sig` is an ERC-1271 signature over `hashRelatedAgentWriteChallenge(...)` —
 *  bound to the content, a one-shot `nonce`, and a short `expiry` (not a replayable constant). */
