 ...
 *     wrangler pages secret put DEMO_A2A_URL --project-name=agenticprimitives-demo-jp
 *
  ...
  if (!env.DEMO_A2A_URL) {
    return new Response(
      JSON.stringify({
        ...
        hint: 'wrangler pages secret put DEMO_A2A_URL --project-name=agenticprimitives-demo-jp',
      }),
