...
`@agenticprimitives/identity-auth` owns user authentication primitives and signer interfaces. It does not own the smart account, concrete KMS signers, delegation sessions, HTTP routes, or persistence.
