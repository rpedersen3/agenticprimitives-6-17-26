...
## Allowed imports
`@agenticprimitives/types`, `@agenticprimitives/connect-auth` (type-only `Signer`), `viem`. Nothing else from `@agenticprimitives/*` (downstream packages create cycles).
