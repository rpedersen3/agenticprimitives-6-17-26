...
| --------------- | -------- | ------------------------------------------------------------------------------------------------------------ | ---------- | -------------------------------------------------------------------------------------- |
| **C1** (system) | P0       | Service-to-service HMAC not load-bearing; this package owns the MAC provider but it isn't enforced anywhere. | Open       | Coordinate with `mcp-runtime` + apps.                                                  |
