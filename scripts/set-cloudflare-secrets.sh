...
# 4. A2A_MASTER_PRIVATE_KEY — fresh EOA. Capture once, expose only address,
#    pipe the private key directly to wrangler stdin via a node parser.
